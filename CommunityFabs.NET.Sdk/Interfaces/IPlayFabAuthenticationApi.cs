...
public interface IPlayFabAuthenticationApi {
    ...
    /// var response = gameserveridentityApi.AuthenticateGameServerWithCustomIdAsync({);
    ...
    /// </summary>
    public Task<AuthenticateCustomIdResult> AuthenticateGameServerWithCustomIdAsync(AuthenticateCustomIdRequest request);
    /// <summary>
    /// Delete a game_server entity.
    /// <example><br/>Example:<code>
    /// var response = gameserveridentityApi.DeleteAsync({);
    ///   "Entity": {
    ///     "Id": "3D00C64954",
    ///     "Type": "game_server",
    ...
    /// </summary>
    public Task<EmptyResponse> DeleteAsync(DeleteRequest request);
    /// <summary>
    /// Method to exchange a legacy AuthenticationTicket or title SecretKey for an Entity Token or to refresh a still valid
    /// Entity Token.
    /// <example><br/>Example:<code>
    /// var response = authenticationApi.GetEntityTokenAsync({});
    /// </code></example>
    ...
    /// </summary>
    public Task<GetEntityTokenResponse> GetEntityTokenAsync(GetEntityTokenRequest request);
    /// <summary>
    /// Method for a server to validate a client provided EntityToken. Only callable by the title entity.
    /// <example><br/>Example:<code>
    /// var response = authenticationApi.ValidateEntityTokenAsync({);
    ...
    /// </summary>
    public Task<ValidateEntityTokenResponse> ValidateEntityTokenAsync(ValidateEntityTokenRequest request);
}