...
public interface IPlayFabMatchmakerApi {
    ...
    /// var response = matchmakerApi.AuthUserAsync({);
    ...
    /// </summary>
    public Task<AuthUserResponse> AuthUserAsync(AuthUserRequest request);
    /// <summary>
    /// Inform the matchmaker that a Game Server Instance is removed.
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.DeregisterGameAsync({);
    ///   "LobbyId": "8285313"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.PlayerJoinedAsync({);
    ///   "LobbyId": "serverID",
    ...
    /// </summary>
    public Task<PlayerJoinedResponse> PlayerJoinedAsync(PlayerJoinedRequest request);
    /// <summary>
    /// Informs the PlayFab game server hosting service that the indicated user has left the Game Server Instance specified
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.PlayerLeftAsync({);
    ///   "LobbyId": "serverID",
    ///   "PlayFabId": "23990802934"
    /// });
    /// </code></example>
    ...
    /// </summary>
    public Task<PlayerLeftResponse> PlayerLeftAsync(PlayerLeftRequest request);
    /// <summary>
    /// Inform the matchmaker that a new Game Server Instance is added.
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.RegisterGameAsync({);
    ...
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.StartGameAsync({);
    ///   "Build": "6.01",
    ///   "Region": "USCentral",
    ...
    /// effective matches
    /// <example><br/>Example:<code>
    /// var response = matchmakerApi.UserInfoAsync({);
    ///   "PlayFabId": "23990802934",
    ///   "MinCatalogVersion": 4
    /// });
    /// </code></example>
    ...
    /// </summary>
    public Task<UserInfoResponse> UserInfoAsync(UserInfoRequest request);
}