...
public class PlayFabServerInstanceApi(PlayFabApiSettings? apiSettings = null, PlayFabAuthenticationContext? authContext = null, HttpClient? httpClient = null) : IPlayFabServerApi {
    ...
    public async Task<PlayFabResult<ModifyCharacterVirtualCurrencyResult>> AddCharacterVirtualCurrencyAsync(AddCharacterVirtualCurrencyRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddCharacterVirtualCurrency", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
    ...
    public async Task<PlayFabResult<EmptyResponse>> AddFriendAsync(AddFriendRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddFriend", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EmptyResult>> AddGenericIDAsync(AddGenericIDRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddGenericID", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<AddOrUpdateContactEmailResult>> AddOrUpdateContactEmailAsync(AddOrUpdateContactEmailRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddOrUpdateContactEmail", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<AddPlayerTagResult>> AddPlayerTagAsync(AddPlayerTagRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddPlayerTag", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<AddSharedGroupMembersResult>> AddSharedGroupMembersAsync(AddSharedGroupMembersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddSharedGroupMembers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ModifyUserVirtualCurrencyResult>> AddUserVirtualCurrencyAsync(AddUserVirtualCurrencyRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AddUserVirtualCurrency", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<AuthenticateSessionTicketResult>> AuthenticateSessionTicketAsync(AuthenticateSessionTicketRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AuthenticateSessionTicket", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<AwardSteamAchievementResult>> AwardSteamAchievementAsync(AwardSteamAchievementRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/AwardSteamAchievement", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<BanUsersResult>> BanUsersAsync(BanUsersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/BanUsers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ConsumeItemResult>> ConsumeItemAsync(ConsumeItemRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/ConsumeItem", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<CreateSharedGroupResult>> CreateSharedGroupAsync(CreateSharedGroupRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/CreateSharedGroup", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<DeleteCharacterFromUserResult>> DeleteCharacterFromUserAsync(DeleteCharacterFromUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeleteCharacterFromUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<DeletePlayerResult>> DeletePlayerAsync(DeletePlayerRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeletePlayer", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<DeletePlayerCustomPropertiesResult>> DeletePlayerCustomPropertiesAsync(DeletePlayerCustomPropertiesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeletePlayerCustomProperties", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<DeletePushNotificationTemplateResult>> DeletePushNotificationTemplateAsync(DeletePushNotificationTemplateRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeletePushNotificationTemplate", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EmptyResponse>> DeleteSharedGroupAsync(DeleteSharedGroupRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeleteSharedGroup", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<DeleteUsersResult>> DeleteUsersAsync(DeleteUsersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeleteUsers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<DeregisterGameResponse>> DeregisterGameAsync(DeregisterGameRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/DeregisterGame", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EvaluateRandomResultTableResult>> EvaluateRandomResultTableAsync(EvaluateRandomResultTableRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/EvaluateRandomResultTable", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ExecuteCloudScriptResult>> ExecuteCloudScriptAsync(ExecuteCloudScriptServerRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/ExecuteCloudScript", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetAllActionGroupsResult>> GetAllActionGroupsAsync(GetAllActionGroupsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetAllActionGroups", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetAllSegmentsResult>> GetAllSegmentsAsync(GetAllSegmentsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetAllSegments", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ListUsersCharactersResult>> GetAllUsersCharactersAsync(ListUsersCharactersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetAllUsersCharacters", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetCatalogItemsResult>> GetCatalogItemsAsync(GetCatalogItemsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCatalogItems", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetCharacterDataResult>> GetCharacterDataAsync(GetCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetCharacterDataResult>> GetCharacterInternalDataAsync(GetCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetCharacterDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetCharacterInventoryResult>> GetCharacterInventoryAsync(GetCharacterInventoryRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterInventory", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetCharacterLeaderboardResult>> GetCharacterLeaderboardAsync(GetCharacterLeaderboardRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterLeaderboard", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetCharacterDataResult>> GetCharacterReadOnlyDataAsync(GetCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetCharacterDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetCharacterStatisticsResult>> GetCharacterStatisticsAsync(GetCharacterStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetCharacterStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetContentDownloadUrlResult>> GetContentDownloadUrlAsync(GetContentDownloadUrlRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetContentDownloadUrl", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetLeaderboardResult>> GetFriendLeaderboardAsync(GetFriendLeaderboardRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetFriendLeaderboard", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetFriendsListResult>> GetFriendsListAsync(GetFriendsListRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetFriendsList", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetLeaderboardResult>> GetLeaderboardAsync(GetLeaderboardRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetLeaderboard", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetLeaderboardResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetLeaderboardAroundCharacterResult>> GetLeaderboardAroundCharacterAsync(GetLeaderboardAroundCharacterRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetLeaderboardAroundCharacter", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetLeaderboardAroundUserResult>> GetLeaderboardAroundUserAsync(GetLeaderboardAroundUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetLeaderboardAroundUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetLeaderboardForUsersCharactersResult>> GetLeaderboardForUserCharactersAsync(GetLeaderboardForUsersCharactersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetLeaderboardForUserCharacters", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerCombinedInfoResult>> GetPlayerCombinedInfoAsync(GetPlayerCombinedInfoRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerCombinedInfo", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerCustomPropertyResult>> GetPlayerCustomPropertyAsync(GetPlayerCustomPropertyRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerCustomProperty", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerProfileResult>> GetPlayerProfileAsync(GetPlayerProfileRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerProfile", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerSegmentsResult>> GetPlayerSegmentsAsync(GetPlayersSegmentsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerSegments", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerStatisticsResult>> GetPlayerStatisticsAsync(GetPlayerStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerStatisticVersionsResult>> GetPlayerStatisticVersionsAsync(GetPlayerStatisticVersionsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerStatisticVersions", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayerTagsResult>> GetPlayerTagsAsync(GetPlayerTagsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayerTags", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromBattleNetAccountIdsResult>> GetPlayFabIDsFromBattleNetAccountIdsAsync(GetPlayFabIDsFromBattleNetAccountIdsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromBattleNetAccountIds", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromFacebookIDsResult>> GetPlayFabIDsFromFacebookIDsAsync(GetPlayFabIDsFromFacebookIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromFacebookIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromFacebookInstantGamesIdsResult>> GetPlayFabIDsFromFacebookInstantGamesIdsAsync(GetPlayFabIDsFromFacebookInstantGamesIdsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromFacebookInstantGamesIds", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromGenericIDsResult>> GetPlayFabIDsFromGenericIDsAsync(GetPlayFabIDsFromGenericIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromGenericIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromNintendoServiceAccountIdsResult>> GetPlayFabIDsFromNintendoServiceAccountIdsAsync(GetPlayFabIDsFromNintendoServiceAccountIdsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromNintendoServiceAccountIds", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromNintendoSwitchDeviceIdsResult>> GetPlayFabIDsFromNintendoSwitchDeviceIdsAsync(GetPlayFabIDsFromNintendoSwitchDeviceIdsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromNintendoSwitchDeviceIds", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromOpenIdsResult>> GetPlayFabIDsFromOpenIdSubjectIdentifiersAsync(GetPlayFabIDsFromOpenIdsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromOpenIdSubjectIdentifiers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromPSNAccountIDsResult>> GetPlayFabIDsFromPSNAccountIDsAsync(GetPlayFabIDsFromPSNAccountIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromPSNAccountIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromPSNOnlineIDsResult>> GetPlayFabIDsFromPSNOnlineIDsAsync(GetPlayFabIDsFromPSNOnlineIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromPSNOnlineIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    /// <inheritdoc />
    public async Task<PlayFabResult<GetPlayFabIDsFromServerCustomIDsResult>> GetPlayFabIDsFromServerCustomIDsAsync(GetPlayFabIDsFromServerCustomIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        var requestContext = request?.AuthenticationContext ?? authContext;
        var requestSettings = apiSettings ?? PlayFabSettings.staticSettings;

        if (requestSettings?.DeveloperSecretKey == null) throw new PlayFabException(PlayFabExceptionCode.DeveloperKeyNotSet, "DeveloperSecretKey must be set in your local or global settings to call this method");

        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromServerCustomIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetPlayFabIDsFromServerCustomIDsResult> { Error = error };
        }

        var resultData = JsonSerializer.Deserialize<PlayFabJsonSuccess<GetPlayFabIDsFromServerCustomIDsResult>>((string)httpResult);
        var result = resultData!.data;

        return new PlayFabResult<GetPlayFabIDsFromServerCustomIDsResult> { Result = result };
    }
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromSteamIDsResult>> GetPlayFabIDsFromSteamIDsAsync(GetPlayFabIDsFromSteamIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromSteamIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromSteamNamesResult>> GetPlayFabIDsFromSteamNamesAsync(GetPlayFabIDsFromSteamNamesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromSteamNames", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromTwitchIDsResult>> GetPlayFabIDsFromTwitchIDsAsync(GetPlayFabIDsFromTwitchIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromTwitchIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPlayFabIDsFromXboxLiveIDsResult>> GetPlayFabIDsFromXboxLiveIDsAsync(GetPlayFabIDsFromXboxLiveIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPlayFabIDsFromXboxLiveIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetPublisherDataResult>> GetPublisherDataAsync(GetPublisherDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetPublisherData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetRandomResultTablesResult>> GetRandomResultTablesAsync(GetRandomResultTablesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetRandomResultTables", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetSegmentPlayerCountResult>> GetSegmentPlayerCountAsync(GetSegmentPlayerCountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetSegmentPlayerCount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetServerCustomIDsFromPlayFabIDsResult>> GetServerCustomIDsFromPlayFabIDsAsync(GetServerCustomIDsFromPlayFabIDsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetServerCustomIDsFromPlayFabIDs", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetSharedGroupDataResult>> GetSharedGroupDataAsync(GetSharedGroupDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetSharedGroupData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetStoreItemsResult>> GetStoreItemsAsync(GetStoreItemsServerRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetStoreItems", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetTimeResult>> GetTimeAsync(GetTimeRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetTime", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetTitleDataResult>> GetTitleDataAsync(GetTitleDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetTitleData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetTitleDataResult>> GetTitleInternalDataAsync(GetTitleDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetTitleInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetTitleDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetTitleNewsResult>> GetTitleNewsAsync(GetTitleNewsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetTitleNews", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetUserAccountInfoResult>> GetUserAccountInfoAsync(GetUserAccountInfoRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserAccountInfo", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetUserBansResult>> GetUserBansAsync(GetUserBansRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserBans", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserInternalDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetUserInventoryResult>> GetUserInventoryAsync(GetUserInventoryRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserInventory", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserPublisherDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserPublisherData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserPublisherInternalDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserPublisherInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserPublisherReadOnlyDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserPublisherReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetUserDataResult>> GetUserReadOnlyDataAsync(GetUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<GetUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<GetUserStatisticsResult>> GetUserStatisticsAsync(GetUserStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GetUserStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GrantCharacterToUserResult>> GrantCharacterToUserAsync(GrantCharacterToUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GrantCharacterToUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GrantItemsToCharacterResult>> GrantItemsToCharacterAsync(GrantItemsToCharacterRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GrantItemsToCharacter", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GrantItemsToUserResult>> GrantItemsToUserAsync(GrantItemsToUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GrantItemsToUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<GrantItemsToUsersResult>> GrantItemsToUsersAsync(GrantItemsToUsersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/GrantItemsToUsers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EmptyResult>> LinkBattleNetAccountAsync(LinkBattleNetAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkBattleNetAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResult>> LinkNintendoServiceAccountAsync(LinkNintendoServiceAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkNintendoServiceAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResult>> LinkNintendoServiceAccountSubjectAsync(LinkNintendoServiceAccountSubjectRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkNintendoServiceAccountSubject", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<LinkNintendoSwitchDeviceIdResult>> LinkNintendoSwitchDeviceIdAsync(LinkNintendoSwitchDeviceIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkNintendoSwitchDeviceId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<LinkPSNAccountResult>> LinkPSNAccountAsync(LinkPSNAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkPSNAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<LinkPSNIdResponse>> LinkPSNIdAsync(LinkPSNIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkPSNId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<LinkServerCustomIdResult>> LinkServerCustomIdAsync(LinkServerCustomIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkServerCustomId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<LinkSteamIdResult>> LinkSteamIdAsync(LinkSteamIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkSteamId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    /// <inheritdoc />
    public async Task<PlayFabResult<EmptyResult>> LinkTwitchAccountAsync(LinkTwitchAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        var requestContext = request?.AuthenticationContext ?? authContext;
        var requestSettings = apiSettings ?? PlayFabSettings.staticSettings;

        if (requestSettings?.DeveloperSecretKey == null) throw new PlayFabException(PlayFabExceptionCode.DeveloperKeyNotSet, "DeveloperSecretKey must be set in your local or global settings to call this method");

        var httpResult = await PlayFabHttp.Post("/Server/LinkTwitchAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<LinkXboxAccountResult>> LinkXboxAccountAsync(LinkXboxAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LinkXboxAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    /// <inheritdoc />
    public async Task<PlayFabResult<LinkXboxAccountResult>> LinkXboxIdAsync(LinkXboxIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        var requestContext = request?.AuthenticationContext ?? authContext;
        var requestSettings = apiSettings ?? PlayFabSettings.staticSettings;

        if (requestSettings?.DeveloperSecretKey == null) throw new PlayFabException(PlayFabExceptionCode.DeveloperKeyNotSet, "DeveloperSecretKey must be set in your local or global settings to call this method");

        var httpResult = await PlayFabHttp.Post("/Server/LinkXboxId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<LinkXboxAccountResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ListPlayerCustomPropertiesResult>> ListPlayerCustomPropertiesAsync(ListPlayerCustomPropertiesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/ListPlayerCustomProperties", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<LogEventResult>> LogEventAsync(LogEventRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LogEvent", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithAndroidDeviceIDAsync(LoginWithAndroidDeviceIDRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithAndroidDeviceID", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithBattleNetAsync(LoginWithBattleNetRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithBattleNet", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithCustomIDAsync(LoginWithCustomIDRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithCustomID", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithIOSDeviceIDAsync(LoginWithIOSDeviceIDRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithIOSDeviceID", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithPSNAsync(LoginWithPSNRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithPSN", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithServerCustomIdAsync(LoginWithServerCustomIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithServerCustomId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithSteamIdAsync(LoginWithSteamIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithSteamId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    /// <inheritdoc />
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithTwitchAsync(LoginWithTwitchRequest? request, Dictionary<string, string>? extraHeaders = null) {
        var requestContext = request?.AuthenticationContext ?? authContext;
        var requestSettings = apiSettings ?? PlayFabSettings.staticSettings;

        if (requestSettings?.DeveloperSecretKey == null) throw new PlayFabException(PlayFabExceptionCode.DeveloperKeyNotSet, "DeveloperSecretKey must be set in your local or global settings to call this method");

        var httpResult = await PlayFabHttp.Post("/Server/LoginWithTwitch", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithXboxAsync(LoginWithXboxRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithXbox", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ServerLoginResult>> LoginWithXboxIdAsync(LoginWithXboxIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/LoginWithXboxId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ServerLoginResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ModifyItemUsesResult>> ModifyItemUsesAsync(ModifyItemUsesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/ModifyItemUses", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<MoveItemToCharacterFromCharacterResult>> MoveItemToCharacterFromCharacterAsync(MoveItemToCharacterFromCharacterRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/MoveItemToCharacterFromCharacter", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<MoveItemToCharacterFromUserResult>> MoveItemToCharacterFromUserAsync(MoveItemToCharacterFromUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/MoveItemToCharacterFromUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<MoveItemToUserFromCharacterResult>> MoveItemToUserFromCharacterAsync(MoveItemToUserFromCharacterRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/MoveItemToUserFromCharacter", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<NotifyMatchmakerPlayerLeftResult>> NotifyMatchmakerPlayerLeftAsync(NotifyMatchmakerPlayerLeftRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/NotifyMatchmakerPlayerLeft", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RedeemCouponResult>> RedeemCouponAsync(RedeemCouponRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RedeemCoupon", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RedeemMatchmakerTicketResult>> RedeemMatchmakerTicketAsync(RedeemMatchmakerTicketRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RedeemMatchmakerTicket", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RefreshGameServerInstanceHeartbeatResult>> RefreshGameServerInstanceHeartbeatAsync(RefreshGameServerInstanceHeartbeatRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RefreshGameServerInstanceHeartbeat", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RegisterGameResponse>> RegisterGameAsync(RegisterGameRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RegisterGame", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EmptyResponse>> RemoveFriendAsync(RemoveFriendRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RemoveFriend", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResult>> RemoveGenericIDAsync(RemoveGenericIDRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RemoveGenericID", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<RemovePlayerTagResult>> RemovePlayerTagAsync(RemovePlayerTagRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RemovePlayerTag", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RemoveSharedGroupMembersResult>> RemoveSharedGroupMembersAsync(RemoveSharedGroupMembersRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RemoveSharedGroupMembers", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<ReportPlayerServerResult>> ReportPlayerAsync(ReportPlayerServerRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/ReportPlayer", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RevokeAllBansForUserResult>> RevokeAllBansForUserAsync(RevokeAllBansForUserRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RevokeAllBansForUser", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RevokeBansResult>> RevokeBansAsync(RevokeBansRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RevokeBans", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RevokeInventoryResult>> RevokeInventoryItemAsync(RevokeInventoryItemRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RevokeInventoryItem", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<RevokeInventoryItemsResult>> RevokeInventoryItemsAsync(RevokeInventoryItemsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/RevokeInventoryItems", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SavePushNotificationTemplateResult>> SavePushNotificationTemplateAsync(SavePushNotificationTemplateRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SavePushNotificationTemplate", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SendCustomAccountRecoveryEmailResult>> SendCustomAccountRecoveryEmailAsync(SendCustomAccountRecoveryEmailRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SendCustomAccountRecoveryEmail", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SendEmailFromTemplateResult>> SendEmailFromTemplateAsync(SendEmailFromTemplateRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SendEmailFromTemplate", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SendPushNotificationResult>> SendPushNotificationAsync(SendPushNotificationRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SendPushNotification", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SendPushNotificationResult>> SendPushNotificationFromTemplateAsync(SendPushNotificationFromTemplateRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SendPushNotificationFromTemplate", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<SendPushNotificationResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResponse>> SetFriendTagsAsync(SetFriendTagsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetFriendTags", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<SetGameServerInstanceDataResult>> SetGameServerInstanceDataAsync(SetGameServerInstanceDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetGameServerInstanceData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetGameServerInstanceStateResult>> SetGameServerInstanceStateAsync(SetGameServerInstanceStateRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetGameServerInstanceState", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetGameServerInstanceTagsResult>> SetGameServerInstanceTagsAsync(SetGameServerInstanceTagsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetGameServerInstanceTags", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetPlayerSecretResult>> SetPlayerSecretAsync(SetPlayerSecretRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetPlayerSecret", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetPublisherDataResult>> SetPublisherDataAsync(SetPublisherDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetPublisherData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetTitleDataResult>> SetTitleDataAsync(SetTitleDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetTitleData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<SetTitleDataResult>> SetTitleInternalDataAsync(SetTitleDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SetTitleInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<SetTitleDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ModifyCharacterVirtualCurrencyResult>> SubtractCharacterVirtualCurrencyAsync(SubtractCharacterVirtualCurrencyRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SubtractCharacterVirtualCurrency", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ModifyCharacterVirtualCurrencyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<ModifyUserVirtualCurrencyResult>> SubtractUserVirtualCurrencyAsync(SubtractUserVirtualCurrencyRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/SubtractUserVirtualCurrency", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<ModifyUserVirtualCurrencyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResponse>> UnlinkBattleNetAccountAsync(UnlinkBattleNetAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkBattleNetAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UnlinkFacebookAccountResult>> UnlinkFacebookAccountAsync(UnlinkFacebookAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkFacebookAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlinkFacebookInstantGamesIdResult>> UnlinkFacebookInstantGamesIdAsync(UnlinkFacebookInstantGamesIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkFacebookInstantGamesId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<EmptyResponse>> UnlinkNintendoServiceAccountAsync(UnlinkNintendoServiceAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkNintendoServiceAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UnlinkNintendoSwitchDeviceIdResult>> UnlinkNintendoSwitchDeviceIdAsync(UnlinkNintendoSwitchDeviceIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkNintendoSwitchDeviceId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlinkPSNAccountResult>> UnlinkPSNAccountAsync(UnlinkPSNAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkPSNAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlinkServerCustomIdResult>> UnlinkServerCustomIdAsync(UnlinkServerCustomIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkServerCustomId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlinkSteamIdResult>> UnlinkSteamIdAsync(UnlinkSteamIdRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkSteamId", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    /// <inheritdoc />
    public async Task<PlayFabResult<EmptyResult>> UnlinkTwitchAccountAsync(UnlinkTwitchAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        var requestContext = request?.AuthenticationContext ?? authContext;
        var requestSettings = apiSettings ?? PlayFabSettings.staticSettings;

        if (requestSettings?.DeveloperSecretKey == null) throw new PlayFabException(PlayFabExceptionCode.DeveloperKeyNotSet, "DeveloperSecretKey must be set in your local or global settings to call this method");

        var httpResult = await PlayFabHttp.Post("/Server/UnlinkTwitchAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UnlinkXboxAccountResult>> UnlinkXboxAccountAsync(UnlinkXboxAccountRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlinkXboxAccount", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlockContainerItemResult>> UnlockContainerInstanceAsync(UnlockContainerInstanceRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlockContainerInstance", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UnlockContainerItemResult>> UnlockContainerItemAsync(UnlockContainerItemRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UnlockContainerItem", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UnlockContainerItemResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResponse>> UpdateAvatarUrlAsync(UpdateAvatarUrlRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateAvatarUrl", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateBansResult>> UpdateBansAsync(UpdateBansRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateBans", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdateCharacterDataResult>> UpdateCharacterDataAsync(UpdateCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateCharacterData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdateCharacterDataResult>> UpdateCharacterInternalDataAsync(UpdateCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateCharacterInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateCharacterDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateCharacterDataResult>> UpdateCharacterReadOnlyDataAsync(UpdateCharacterDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateCharacterReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateCharacterDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateCharacterStatisticsResult>> UpdateCharacterStatisticsAsync(UpdateCharacterStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateCharacterStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdatePlayerCustomPropertiesResult>> UpdatePlayerCustomPropertiesAsync(UpdatePlayerCustomPropertiesRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdatePlayerCustomProperties", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdatePlayerStatisticsResult>> UpdatePlayerStatisticsAsync(UpdatePlayerStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdatePlayerStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdateSharedGroupDataResult>> UpdateSharedGroupDataAsync(UpdateSharedGroupDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateSharedGroupData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserDataAsync(UpdateUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserInternalDataAsync(UpdateUserInternalDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<EmptyResponse>> UpdateUserInventoryItemCustomDataAsync(UpdateUserInventoryItemDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserInventoryItemCustomData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<EmptyResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserPublisherDataAsync(UpdateUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserPublisherData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserPublisherInternalDataAsync(UpdateUserInternalDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserPublisherInternalData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserPublisherReadOnlyDataAsync(UpdateUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserPublisherReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateUserDataResult>> UpdateUserReadOnlyDataAsync(UpdateUserDataRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserReadOnlyData", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<UpdateUserDataResult> { Error = error };
        }
    ...
    public async Task<PlayFabResult<UpdateUserStatisticsResult>> UpdateUserStatisticsAsync(UpdateUserStatisticsRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/UpdateUserStatistics", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<WriteEventResponse>> WriteCharacterEventAsync(WriteServerCharacterEventRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/WriteCharacterEvent", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
    ...
    public async Task<PlayFabResult<WriteEventResponse>> WritePlayerEventAsync(WriteServerPlayerEventRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/WritePlayerEvent", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<WriteEventResponse> { Error = error };
        }
    ...
    public async Task<PlayFabResult<WriteEventResponse>> WriteTitleEventAsync(WriteTitleEventRequest? request, Dictionary<string, string>? extraHeaders = null) {
        ...
        var httpResult = await PlayFabHttp.Post("/Server/WriteTitleEvent", request, "X-SecretKey", requestSettings.DeveloperSecretKey, extraHeaders, requestSettings, httpClient);
        if (httpResult is PlayFabError error)
        {
            return new PlayFabResult<WriteEventResponse> { Error = error };
        }
