...
/// <summary>
/// Request to extend the lifetime of a PubSub connection by providing a new entity token.
/// </summary>
public class PubSubExtendConnectionLifetimeRequest : PlayFabRequestCommon {
    /// <summary>
...
/// <summary>
/// Result of extending the lifetime of a PubSub connection.
/// </summary>
public class PubSubExtendConnectionLifetimeResult : PlayFabResultCommon {
    /// <summary>
...
public class UpdateLobbyRequest : PlayFabRequestCommon {
    ...
    /// <summary>
    /// A setting that controls whether only the lobby owner can send invites to join the lobby. When true, only the lobby
    /// owner can send invites. When false or not specified, any member can send invites. Will not modify current configuration
    /// if not specified. Restricted to client owned lobbies.
    /// </summary>
    public bool? RestrictInvitesToLobbyOwner { get; set; }
    /// <summary>
