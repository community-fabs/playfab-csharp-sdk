...
public interface IPlayFabMatchmakerApi {
    ...
    /// var response = await matchmakingApi.AuthUserAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.PlayerJoinedAsync({
    ///   "LobbyId": "serverID",
    ...
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.PlayerLeftAsync({
    ///   "LobbyId": "serverID",
    ///   "PlayFabId": "23990802934"
    /// });
    /// </code></example>
    ...
    /// effective matches
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.UserInfoAsync({
    ///   "PlayFabId": "23990802934",
    ///   "MinCatalogVersion": 4
    /// });
    /// </code></example>
