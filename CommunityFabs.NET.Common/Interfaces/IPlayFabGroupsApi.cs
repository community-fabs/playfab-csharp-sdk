...
public interface IPlayFabGroupsApi {
    ...
    /// var response = await groupsApi.AcceptGroupApplicationAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Entity": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.AcceptGroupInvitationAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.AddMembersAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Members": [
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ApplyToGroupAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.BlockEntityAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Entity": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ChangeMemberRoleAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ...
    /// Creates a new group.
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.CreateGroupAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.CreateRoleAsync({
    ///   "RoleId": "example",
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.DeleteGroupAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.DeleteRoleAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "RoleId": "ABC1234DEF"
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.GetGroupAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.InviteToGroupAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.IsMemberAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "RoleId": "ABC1234DEF",
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListGroupApplicationsAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListGroupBlocksAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListGroupInvitationsAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListGroupMembersAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListMembershipAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.ListMembershipOpportunitiesAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.RemoveGroupApplicationAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Entity": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.RemoveGroupInvitationAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Entity": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.RemoveMembersAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "RoleId": "ABC1234DEF",
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.UnblockEntityAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "Entity": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.UpdateGroupAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ...
    /// <example><br/>Example:<code>
    /// var response = await groupsApi.UpdateRoleAsync({
    ///   "Group": {
    ///     "Id": "ABC1234ABC"
    ///   },
    ///   "RoleId": "ABC1234DEF",
