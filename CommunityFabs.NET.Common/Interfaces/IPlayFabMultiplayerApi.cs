...
public interface IPlayFabMultiplayerApi {
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CancelMatchmakingTicketAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CancelModelAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CancelServerBackfillTicketAsync({
    ///   "TicketId": "1c4b0daa-150e-47ae-9923-d770c0f9b07c",
    ///   "QueueName": "custom123"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBaseModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBatchModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelName": "Test Batch Model",
    ///   "Conditions": [
    ///     {
    ...
    ///   "MatchResultStartTimeUtc": "2026-03-09T06:10:37.175Z",
    ///   "MatchResultEndTimeUtc": "2026-03-09T06:40:37.175Z",
    ///   "MaxIterations": 100,
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBuildAliasAsync({
    ///   "AliasName": "AliasName",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBuildWithCustomContainerAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBuildWithManagedContainerAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateBuildWithProcessBasedServerAsync({
    ///   "OsPlatform": "Windows",
    ///   "GameAssetReferences": [
    ///     {
    ///       "FileName": "game.zip"
    ...
    /// Create a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateLobbyAsync({
    ///   "MaxPlayers": 50,
    ///   "Owner": {
    ///     "Id": "1234",
    ///     "Type": "title_player_account",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateMatchmakingTicketAsync({
    ///   "Creator": {},
    ///   "MembersToMatchWith": [],
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateRemoteUserAsync({
    ...
    /// results.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateScenarioAsync({
    ///   "Name": "Test Scenario",
    ///   "Conditions": [
    ///     {
    ///       "Key": "Platform",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateServerBackfillTicketAsync({
    ///   "Members": [],
    ///   "GiveUpAfterSeconds": 100,
    ///   "ServerDetails": {
    ...
    /// matchmaking tickets.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateServerMatchmakingTicketAsync({
    ///   "Members": [
    ///     null
    ///   ],
    ///   "GiveUpAfterSeconds": 100,
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.CreateTitleMultiplayerServersQuotaChangeAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeactivateModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteAssetAsync({
    ///   "FileName": "gameserver.zip"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteBuildAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteBuildAliasAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteBuildRegionAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "JapanEast"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteCertificateAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteContainerImageRepositoryAsync({
    ...
    /// Delete a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteLobbyAsync({
    ...
    /// Delete a model.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteRemoteUserAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "SouthCentralUs",
    ///   "VmId": "VmID1",
    ///   "Username": "AUsername"
    ...
    /// Delete a scenario.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteScenarioAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ForceDelete": true
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.DeleteSecretAsync({
    ///   "Name": "GameSecret1"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.EnableMultiplayerServersForTitleAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.EnablePartiesForTitleAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.FindFriendLobbiesAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.FindLobbiesAsync({
    ///   "Filter": "string_key1 eq 'Wizard' and number_key5 gt 5",
    ///   "OrderBy": "number_key5 desc",
    ///   "Pagination": {
    ///     "ContinuationToken": "",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetAssetDownloadUrlAsync({
    ///   "FileName": "gameserver.zip"
    /// });
    /// </code></example>
    ...
    /// te&amp;se=endDate&amp;spr=https&amp;sig=sampleSig&amp;api-version=2017-07-29
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetAssetUploadUrlAsync({
    ///   "FileName": "gameserver.zip"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetBuildAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetBuildAliasAsync({
    ///   "AliasId": "21781fa8-096d-4d9c-b699-75433d579285"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetCognitiveServicesLocalesAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetCognitiveServicesTokenAsync({
    ///   "CognitiveServicesType": "SpeechToText",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetContainerRegistryCredentialsAsync({});
    /// </code></example>
    ...
    /// Get a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetLobbyAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC"
    /// });
    /// </code></example>
    ...
    /// Get a match.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMatchAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMatchmakingQueueAsync({
    ///   "QueueName": "custom123"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMatchmakingTicketAsync({
    ///   "TicketId": "1c4b0daa-150e-47ae-9923-d770c0f9b07c",
    ///   "QueueName": "custom123",
    ///   "EscapeObject": false
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetModelDetailsAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetModelsByScenarioAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMultiplayerServerAndTokenAsync({
    ///   "TokenPlayerIds": [
    ///     "User1",
    ///     "User2"
    ///   ],
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMultiplayerServerDetailsAsync({
    ///   "SessionId": "02bdef0e-e01e-4b29-8efe-ff9f47a06d8c"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMultiplayerServerLogsAsync({
    ///   "Region": "AustraliaEast",
    ...
    /// Gets multiplayer server logs after a server has terminated.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetMultiplayerSessionLogsBySessionIdAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetPlayerSkillAsync({
    ///   "Conditions": {
    ///     "Platform": "Xbox",
    ///     "Mode": "Deathmatch"
    ///   },
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetPlayerSkillForConditionsAsync({
    ///   "Conditions": [
    ///     {
    ///       "Conditions": {
    ///         "Platform": "Xbox",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetPlayerSkillForConditionsFromModelAsync({
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf",
    ///   "Conditions": [
    ///     {
    ///       "Conditions": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetPlayerSkillFromModelAsync({
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf",
    ///   "Conditions": {
    ///     "Platform": "Xbox",
    ///     "Mode": "Deathmatch"
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetQueueStatisticsAsync({
    ///   "QueueName": "custom123"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetRemoteLoginEndpointAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "SouthCentralUs",
    ///   "VmId": "VmID1"
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetScenarioConfigurationAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetServerBackfillTicketAsync({
    ///   "TicketId": "1c4b0daa-150e-47ae-9923-d770c0f9b07c",
    ///   "QueueName": "custom123",
    ///   "EscapeObject": false
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetTitleEnabledForMultiplayerServersStatusAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetTitleMultiplayerServersQuotaChangeAsync({
    ///   "RequestId": "1234"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.GetTitleMultiplayerServersQuotasAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.InviteToLobbyAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC",
    ///   "MemberEntity": {
    ///     "Id": "1234",
    ///     "Type": "title_player_account",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.JoinArrangedLobbyAsync({
    ///   "MaxPlayers": 50,
    ///   "OwnerMigrationPolicy": "Automatic",
    ///   "UseConnections": true,
    ///   "AccessPolicy": "Public",
    ...
    /// Join a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.JoinLobbyAsync({
    ///   "MemberEntity": {
    ///     "Id": "1234",
    ///     "Type": "title_player_account",
    ///     "TypeString": "title_player_account"
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.JoinLobbyAsServerAsync({
    ///   "ServerEntity": {
    ///     "Id": "1234",
    ///     "Type": "game_server",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.JoinMatchmakingTicketAsync({
    ///   "TicketId": "1c4b0daa-150e-47ae-9923-d770c0f9b07c",
    ///   "QueueName": "custom123",
    ///   "Member": {}
    /// });
    ...
    /// Leave a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.LeaveLobbyAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC",
    ///   "MemberEntity": {
    ///     "Id": "1234",
    ///     "Type": "title_player_account",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.LeaveLobbyAsServerAsync({
    ///   "ServerEntity": {
    ///     "Id": "1234",
    ///     "Type": "game_server",
    ///     "TypeString": "game_server"
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListArchivedMultiplayerServersAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "SouthCentralUs"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListAssetSummariesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListBuildAliasesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListBuildSummariesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// access is enabled, allows game client to request list of builds with player entity token.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListBuildSummariesV2Async({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListCertificateSummariesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListContainerImagesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListContainerImageTagsAsync({
    ///   "ImageName": "imageName1",
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListMatchmakingQueuesAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListMultiplayerServersAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "SouthCentralUs"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListPartyQosServersAsync({
    ///   "Version": "1.0.0"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListQosServersAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListQosServersForTitleAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListSecretSummariesAsync({
    ///   "PageSize": 10
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListTitleMultiplayerServersQuotaChangesAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ListVirtualMachineSummariesAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "Region": "SouthCentralUs",
    ///   "PageSize": 10
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RemoveMatchmakingQueueAsync({
    ///   "QueueName": "custom123"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RemoveMemberAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC",
    ///   "MemberEntity": {
    ///     "Id": "1234",
    ///     "Type": "title_player_account",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RequestMultiplayerServerAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "SessionId": "02bdef0e-e01e-4b29-8efe-ff9f47a06d8c",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RequestMultiplayerServerAndTokenAsync({
    ///   "TokenPlayerIds": [
    ///     "gamer1",
    ///     "gamer2"
    ///   ],
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RequestPartyAsync({
    ...
    /// Request a party session.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RequestPartyServiceAsync({
    ///   "TitleId": "12345",
    ///   "PartyId": "23781fa9-e01e-4b29-4f0b-dd9f37a06a1e",
    ///   "PreferredRegions": [
    ///     "EastUs",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.RolloverContainerRegistryCredentialsAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.SetMatchmakingQueueAsync({
    ///   "MatchmakingQueue": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.ShutdownMultiplayerServerAsync({
    ///   "Region": "AustraliaEast",
    ///   "SessionId": "02bdef0e-e01e-4b29-8efe-ff9f47a06d8c"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.SubscribeToLobbyResourceAsync({
    ///   "Type": "LobbyChange",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.SubscribeToMatchmakingResourceAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UnsubscribeFromLobbyResourceAsync({
    ///   "Type": "LobbyChange",
    ///   "ResourceId": "5c905725-0184-4112-a563-2f4187710d06",
    ///   "SubscriptionVersion": 1,
    ///   "PubSubConnectionHandle": "PubSubConnection",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UnsubscribeFromMatchmakingResourceAsync({
    ///   "Type": "MatchTicketStatusChange",
    ///   "ResourceId": "5a58afee-a9d7-4a47-875b-48bae4dc0590",
    ///   "SubscriptionVersion": 1,
    ///   "PubSubConnectionHandle": "PubSubConnection",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UntagContainerImageAsync({
    ///   "ImageName": "imageName1",
    ///   "Tag": "tag1"
    /// });
    /// </code></example>
    ...
    /// Creates a multiplayer server build alias.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateBuildAliasAsync({
    ///   "AliasName": "AliasName",
    ///   "BuildSelectionCriteria": [
    ///     {
    ///       "BuildWeightDistribution": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateBuildNameAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "BuildName": "GameBuildName"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateBuildRegionAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "BuildRegion": {
    ///     "Region": "NorthEurope",
    ///     "MaxServers": 7,
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateBuildRegionsAsync({
    ///   "BuildId": "21781fa8-096d-4d9c-b699-75433d579285",
    ///   "BuildRegions": [
    ///     {
    ///       "Region": "EastUs",
    ...
    /// Update a lobby.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateLobbyAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC",
    ///   "MaxPlayers": 50,
    ...
    /// behavior.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateLobbyAsServerAsync({
    ///   "LobbyId": "12345678-1234-1234-1234-123456789ABC",
    ///   "ServerEntity": {
    ///     "Id": "1234",
    ///     "Type": "game_server",
    ...
    /// Update a model.
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdatePrimaryModelAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///   "ModelId": "73a2506e-9fd3-4d84-8dd7-570c8e9e02cf"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UpdateScenarioConfigurationAsync({
    ///   "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UploadCertificateAsync({
    ///   "GameCertificate": {
    ///     "Name": "GameCertificate1",
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UploadMatchResultAsync({
    ///   "MatchResult": {
    ///     "ScenarioId": "f9f0331e-0149-42ba-a994-29b18cac4e4d",
    ///     "Teams": [
    ///       {
    ...
    ///       }
    ///     ],
    ///     "StartDateTimeUtc": "2026-03-09T06:10:37.165Z",
    ///     "EndDateTimeUtc": "2026-03-09T06:40:37.165Z"
    ///   }
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await multiplayerApi.UploadSecretAsync({
    ///   "GameSecret": {
    ///     "Name": "GameSecret1",
    ///     "Value": "Value123",
