...
public interface IPlayFabAdminApi {
    ...
    /// var response = await scheduledtaskApi.AbortTaskInstanceAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.AddLocalizedNewsAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.AddNewsAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await custom-server-managementApi.AddServerBuildAsync({
    ///   "BuildId": "5.0.1",
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.AddVirtualCurrencyTypesAsync({
    ///   "VirtualCurrencies": [
    ///     {
    ///       "CurrencyCode": "CC",
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-item-managementApi.CheckLimitedEditionItemAvailabilityAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.CreateActionsOnPlayersInSegmentTaskAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.CreateCloudScriptAzureFunctionsTaskAsync({
    ...
    /// Create a CloudScript task, which can run a CloudScript on a schedule.
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.CreateCloudScriptTaskAsync({
    ///   "Name": "EnableWeekdayHappyHour",
    ///   "Description": "Turn on special pricing for weekday happy hour.",
    ///   "Schedule": "0 17 * * 1-5",
    ///   "IsActive": false,
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.CreateInsightsScheduledScalingTaskAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.CreateOpenIdConnectionAsync({
    ...
    /// this API returns.
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.CreatePlayerSharedSecretAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.CreatePlayerStatisticDefinitionAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await segmentsApi.CreateSegmentAsync({
    ///   "SegmentModel": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await contentApi.DeleteContentAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await playstreamApi.DeleteEventSinkAsync({
    ///   "Name": "MyStorage"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.DeleteMasterPlayerAccountAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.DeleteMasterPlayerEventDataAsync({
    ///   "PlayFabId": "A68C908B66C23C5"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.DeleteMembershipSubscriptionAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.DeleteOpenIdConnectionAsync({
    ///   "ConnectionId": "oidconnection1"
    /// });
    /// </code></example>
    ...
    /// API returns.
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.DeletePlayerSharedSecretAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await segmentsApi.DeleteSegmentAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.DeleteStoreAsync({
    ///   "StoreId": "BonusStore"
    /// });
    /// </code></example>
    ...
    /// Delete a task.
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.DeleteTaskAsync({
    ///   "Identifier": {
    ///     "Id": "E1772FD927D8539D"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.DeleteTitleAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.DeleteTitleDataOverrideAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.ExportMasterPlayerDataAsync({
    ///   "PlayFabId": "A68C908B66C23C5"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await playstreamApi.ExportPlayersInSegmentAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.GetActionsOnPlayersInSegmentTaskInstanceAsync({
    ///   "TaskInstanceId": "E52531B47B1761C7-4"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.GetCloudScriptAzureFunctionsTaskInstanceAsync({
    ///   "TaskInstanceId": "E52531B47B1761C7-4"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await server-side-cloud-scriptApi.GetCloudScriptRevisionAsync({
    ///   "Version": 1,
    ///   "Revision": 3
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.GetCloudScriptTaskInstanceAsync({
    ///   "TaskInstanceId": "E52531B47B1761C7-4"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await server-side-cloud-scriptApi.GetCloudScriptVersionsAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await contentApi.GetContentListAsync({
    ///   "Prefix": "2016/1"
    /// });
    /// </code></example>
    ...
    /// rates apply.
    /// <example><br/>Example:<code>
    /// var response = await contentApi.GetContentUploadUrlAsync({
    ///   "Key": "images/sword_icon.png",
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.GetDataReportAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await playstreamApi.GetEventSinksAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.GetMatchmakerGameInfoAsync({
    ///   "LobbyId": "2938488"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.GetMatchmakerGameModesAsync({
    ///   "BuildVersion": "5.0.1"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetPlayedTitleListAsync({
    ///   "PlayFabId": "A68C908B66C23C5"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetPlayerIdFromAuthTokenAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.GetPlayerSharedSecretsAsync({});
    /// </code></example>
    ...
    /// a reset interval.
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.GetPlayerStatisticDefinitionsAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.GetPolicyAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.GetRandomResultTablesAsync({});
    /// </code></example>
    ...
    /// 'State' of the export
    /// <example><br/>Example:<code>
    /// var response = await playstreamApi.GetSegmentExportAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await segmentsApi.GetSegmentsAsync({
    ///   "SegmentIds": [
    ///     "B05FC8CB558A6570",
    ///     "97EF0E9302CBE996"
    ///   ]
    ...
    /// <example><br/>Example:<code>
    /// var response = await custom-server-managementApi.GetServerBuildInfoAsync({
    ///   "BuildId": "5.0.1"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await xbox-storeApi.GetStoreMetricsAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.GetTaskInstancesAsync({
    ///   "StatusFilter": "Failed",
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.GetTasksAsync({
    ///   "Identifier": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-item-managementApi.IncrementLimitedEditionItemAvailabilityAsync({
    ///   "CatalogVersion": "Rares",
    ///   "ItemId": "FreeHoodie",
    ///   "Amount": 50
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.IncrementPlayerStatisticVersionAsync({
    ///   "StatisticName": "headshots"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.ListOpenIdConnectionAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await custom-server-managementApi.ListServerBuildsAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.ListVirtualCurrencyTypesAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await matchmakingApi.ModifyMatchmakerGameModesAsync({
    ///   "BuildVersion": "5.0.1",
    ///   "GameModes": [
    ///     {
    ///       "Gamemode": "0",
    ...
    /// <example><br/>Example:<code>
    /// var response = await custom-server-managementApi.ModifyServerBuildAsync({
    ///   "BuildId": "5.0.1",
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.RefundPurchaseAsync({
    ///   "PlayFabId": "20394883",
    ///   "OrderId": "B456AE0",
    ...
    /// StartGame
    /// <example><br/>Example:<code>
    /// var response = await custom-server-managementApi.RemoveServerBuildAsync({
    ///   "BuildId": "5.0.1"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.RemoveVirtualCurrencyTypesAsync({
    ///   "VirtualCurrencies": [
    ///     {
    ///       "CurrencyCode": "CC"
    ///     },
    ...
    /// <example><br/>Example:<code>
    /// var response = await charactersApi.ResetCharacterStatisticsAsync({
    ///   "PlayFabId": "293753934",
    ///   "CharacterId": "7654321"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.ResetPasswordAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.ResetUsersAsync({
    ///   "Users": [
    ///     {
    ///       "Username": "John"
    ///     }
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.ResetUserStatisticsAsync({
    ///   "PlayFabId": "293753934"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.ResolvePurchaseDisputeAsync({
    ///   "PlayFabId": "20394883",
    ///   "OrderId": "B456AE0",
    ///   "Reason": "Customer Request",
    ///   "Outcome": "Reinstate"
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.RunTaskAsync({
    ///   "Identifier": {
    ///     "Id": "E1772FD927D8539D"
    ///   }
    /// });
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.SetCatalogItemsAsync({
    ///   "CatalogVersion": "5",
    ///   "Catalog": [
    ///     {
    ...
    /// <example><br/>Example:<code>
    /// var response = await playstreamApi.SetEventSinkAsync({
    ///   "Sink": {
    ///     "Name": "MyStorage",
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetMembershipOverrideAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await server-side-cloud-scriptApi.SetPublishedRevisionAsync({
    ///   "Version": 1,
    ///   "Revision": 3
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await shared-group-dataApi.SetPublisherDataAsync({
    ///   "Key": "Running Speed",
    ///   "Value": "1.03"
    /// });
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.SetStoreItemsAsync({
    ///   "StoreId": "BonusStore",
    ///   "Store": [
    ///     {
    ///       "ItemId": "shield_level_5",
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.SetTitleDataAndOverridesAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.SetupPushNotificationAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.UpdateCatalogItemsAsync({
    ///   "CatalogVersion": "5",
    ///   "Catalog": [
    ///     {
    ///       "ItemId": "shield_level_5",
    ...
    /// <example><br/>Example:<code>
    /// var response = await server-side-cloud-scriptApi.UpdateCloudScriptAsync({
    ///   "Files": [
    ///     {
    ///       "Filename": "main.js",
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.UpdateOpenIdConnectionAsync({
    ///   "ConnectionId": "oidconnection1",
    ///   "ClientId": "example_id_1",
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.UpdatePlayerSharedSecretAsync({
    ///   "SecretKey": "keysaresecret",
    ...
    /// <example><br/>Example:<code>
    /// var response = await player-data-managementApi.UpdatePlayerStatisticDefinitionAsync({
    ///   "StatisticName": "headshots",
    ...
    /// <example><br/>Example:<code>
    /// var response = await authenticationApi.UpdatePolicyAsync({
    ///   "PolicyName": "ApiPolicy",
    ///   "Statements": [
    ///     {
    ///       "Resource": "pfrn:api--*",
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.UpdateRandomResultTablesAsync({
    ///   "Tables": [
    ///     {
    ///       "TableId": "DropTable 1",
    ///       "Nodes": [
    ...
    /// <example><br/>Example:<code>
    /// var response = await segmentsApi.UpdateSegmentAsync({
    ///   "SegmentModel": {
    ...
    /// <example><br/>Example:<code>
    /// var response = await title-wide-data-managementApi.UpdateStoreItemsAsync({
    ///   "StoreId": "BonusStore",
    ///   "Store": [
    ///     {
    ///       "ItemId": "shield_level_5",
    ...
    /// <example><br/>Example:<code>
    /// var response = await scheduledtaskApi.UpdateTaskAsync({
    ///   "Identifier": {
