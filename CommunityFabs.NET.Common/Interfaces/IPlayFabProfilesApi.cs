...
public interface IPlayFabProfilesApi {
    ...
    /// var response = await account-managementApi.GetGlobalPolicyAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetProfileAsync({
    ///   "Entity": {
    ///     "Id": "1234567787392",
    ...
    /// Retrieves the entity's profile.
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetProfilesAsync({
    ///   "Entities": [
    ///     {
    ///       "Id": "1234567787392",
    ///       "Type": "title_player_account",
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetTitlePlayersFromMasterPlayerAccountIdsAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.GetTitlePlayersFromXboxLiveIDsAsync({
    ///   "XboxLiveIds": [
    ///     "1233455677"
    ///   ],
    ///   "Sandbox": "RETAIL"
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetAvatarUrlAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetDisplayNameAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetGlobalPolicyAsync({
    ///   "Permissions": [
    ///     {
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetProfileLanguageAsync({
    ///   "Language": "en",
    ///   "ExpectedVersion": 123,
    ///   "Entity": {
    ///     "Id": "1234",
    ...
    /// <example><br/>Example:<code>
    /// var response = await account-managementApi.SetProfilePolicyAsync({
    ///   "Statements": [
    ///     {
