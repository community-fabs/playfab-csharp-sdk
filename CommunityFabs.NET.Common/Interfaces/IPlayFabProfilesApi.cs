...
public interface IPlayFabProfilesApi {
    ...
    /// var response = await profilesApi.GetGlobalPolicyAsync({});
    /// </code></example>
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.GetTitlePlayersFromMasterPlayerAccountIdsAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.GetTitlePlayersFromXboxLiveIDsAsync({
    ///   "XboxLiveIds": [
    ///     "1233455677"
    ///   ],
    ///   "Sandbox": "RETAIL"
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.SetAvatarUrlAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.SetDisplayNameAsync({
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.SetGlobalPolicyAsync({
    ///   "Permissions": [
    ///     {
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.SetProfileLanguageAsync({
    ///   "Language": "en",
    ///   "ExpectedVersion": 123,
    ///   "Entity": {
    ///     "Id": "1234",
    ...
    /// <example><br/>Example:<code>
    /// var response = await profilesApi.SetProfilePolicyAsync({
    ///   "Statements": [
    ///     {
